...
// AlexMaladif.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CAlexMaladifApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CAlexMaladifApp

CAlexMaladifApp::CAlexMaladifApp()
{
...
// Seul et unique objet CAlexMaladifApp

CAlexMaladifApp theApp;


// initialisation de CAlexMaladifApp

BOOL CAlexMaladifApp::InitInstance()
{
