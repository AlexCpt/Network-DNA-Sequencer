================================================================================
    BIBLIOTHÈQUE MFC (MICROSOFT FOUNDATION CLASS) : Vue d'ensemble du projet ClientMaladif
===============================================================================

L'Assistant Application a créé cette application ClientMaladif pour vous. Cette application décrit non seulement les bases de l'utilisation de Microsoft Foundation Classes, mais est également un point de départ pour l'écriture de votre application.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application ClientMaladif.

ClientMaladif.vcxproj
...
ClientMaladif.h
    ...
    Il comprend d'autres en-têtes spécifiques au projet (notamment Resource.h) et déclare la classe d'application CClientMaladifApp.

ClientMaladif.cpp
    Il s'agit du fichier source principal de l'application qui contient la classe d'application CClientMaladifApp.
...
res\ClientMaladif.ico
    Il s'agit d'un fichier icône, qui est utilisé comme icône de l'application. Cette icône est incluse par le fichier de ressources principal ClientMaladif.rc.

res\ClientMaladif.rc2
...
ClientMaladifDlg.h, ClientMaladifDlg.cpp - la boîte de dialogue
    Ces fichiers contiennent votre classe CClientMaladifDlg. Cette classe définit le comportement de la boîte de dialogue principale de votre application. Le modèle de la boîte de dialogue se trouve dans ClientMaladif.rc, qui peut être modifié dans Microsoft Visual C++.
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) ClientMaladif.pch et un fichier de type précompilé nommé StdAfx.obj.
