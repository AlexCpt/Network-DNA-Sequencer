...
// ClientMaladif.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CClientMaladifApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CClientMaladifApp

CClientMaladifApp::CClientMaladifApp()
{
...
// Seul et unique objet CClientMaladifApp

CClientMaladifApp theApp;


// initialisation de CClientMaladifApp

BOOL CClientMaladifApp::InitInstance()
{
